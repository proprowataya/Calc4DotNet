                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 08 */ new LowLevelOperation(Opcode.LoadConst, 2),
                                /* 09 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 10 */ new LowLevelOperation(Opcode.GotoIfGreaterThanOrEqual, 12),
                                /* 11 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 12 */ new LowLevelOperation(Opcode.Goto, 13),
                                /* 13 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                /* 14 */ new LowLevelOperation(Opcode.Halt, 0)
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 08 */ new LowLevelOperation(Opcode.LoadConst, 2),
                                /* 09 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 10 */ new LowLevelOperation(Opcode.GotoIfGreaterThan, 12),
                                /* 11 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 12 */ new LowLevelOperation(Opcode.Goto, 13),
                                /* 13 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                /* 14 */ new LowLevelOperation(Opcode.Halt, 0)
                            ...
                            new LowLevelUserDefinedOperator[]
                            {
                                new LowLevelUserDefinedOperator(
                                    ...
                                    new LowLevelOperation[]
                                    {
                                        ...
                                        /* 18 */ new LowLevelOperation(Opcode.Return, 2),
                        ...
                        new LowLevelModule<Int32>(
                            ...
                            new LowLevelUserDefinedOperator[]
                            {
                                new LowLevelUserDefinedOperator(
                                    ...
                                    {
                                        /* 00 */ new LowLevelOperation(Opcode.LoadArg, 2),
                                        /* 01 */ new LowLevelOperation(Opcode.GotoIfFalse, 10),
                                        /* 02 */ new LowLevelOperation(Opcode.LoadArg, 2),
                                        /* 03 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                        /* 04 */ new LowLevelOperation(Opcode.Sub, 0),
                                        /* 05 */ new LowLevelOperation(Opcode.LoadArg, 2),
                                        /* 06 */ new LowLevelOperation(Opcode.LoadArg, 1),
                                        /* 07 */ new LowLevelOperation(Opcode.Mult, 0),
                                        /* 08 */ new LowLevelOperation(Opcode.StoreArg, 1),
                                        /* 09 */ new LowLevelOperation(Opcode.StoreArg, 2),
                                        /* 10 */ new LowLevelOperation(Opcode.Goto, -1),
                                        /* 11 */ new LowLevelOperation(Opcode.LoadArg, 1),
                                        /* 12 */ new LowLevelOperation(Opcode.Return, 2)
                                    }.ToImmutableArray(),
                                    3)
                            }.ToImmutableArray(),
                            new String[]
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 03 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                /* 04 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 05 */ new LowLevelOperation(Opcode.GotoIfFalse, 11),
                                /* 06 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 07 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 08 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 09 */ new LowLevelOperation(Opcode.LoadConst, 2),
                                /* 10 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 11 */ new LowLevelOperation(Opcode.GotoIfTrue, 17),
                                /* 12 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 13 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 14 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 15 */ new LowLevelOperation(Opcode.LoadConst, 4),
                                /* 16 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 17 */ new LowLevelOperation(Opcode.Goto, 22),
                                /* 18 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 19 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 20 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 21 */ new LowLevelOperation(Opcode.LoadConst, 3),
                                /* 22 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 23 */ new LowLevelOperation(Opcode.Halt, 0)
                            }.ToImmutableArray(),
                            new Int32[]
                ...
                new CompilationResult<Int32>(
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                /* 00 */ new LowLevelOperation(Opcode.LoadConst, 4),
                                /* 01 */ new LowLevelOperation(Opcode.Halt, 0)
                            }.ToImmutableArray(),
                            new Int32[]
                            {
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 03 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                /* 04 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 05 */ new LowLevelOperation(Opcode.GotoIfTrue, 17),
                                /* 06 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 07 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 08 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 09 */ new LowLevelOperation(Opcode.LoadConst, 2),
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 03 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                /* 04 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 05 */ new LowLevelOperation(Opcode.GotoIfFalse, 16),
                                /* 06 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 07 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 08 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 09 */ new LowLevelOperation(Opcode.LoadConst, 6),
                                /* 10 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 11 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 12 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 13 */ new LowLevelOperation(Opcode.LoadConst, 5),
                                /* 14 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 15 */ new LowLevelOperation(Opcode.PrintChar, 0),
                                /* 16 */ new LowLevelOperation(Opcode.GotoIfTrue, 18),
                                /* 17 */ new LowLevelOperation(Opcode.LoadConst, 0),
                ...
                new CompilationResult<Int32>(
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                /* 00 */ new LowLevelOperation(Opcode.LoadConst, 65),
                                /* 01 */ new LowLevelOperation(Opcode.PrintChar, 0),
                                /* 02 */ new LowLevelOperation(Opcode.Pop, 0),
                                /* 03 */ new LowLevelOperation(Opcode.LoadConst, 0),
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 03 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                /* 04 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 05 */ new LowLevelOperation(Opcode.GotoIfTrue, 18),
                                /* 06 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 07 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 08 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 09 */ new LowLevelOperation(Opcode.LoadConst, 6),
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 03 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 04 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 05 */ new LowLevelOperation(Opcode.GotoIfFalse, 17),
                                /* 06 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 07 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 08 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 09 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                /* 10 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 11 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 12 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 13 */ new LowLevelOperation(Opcode.Mult, 0),
                                ...
                                /* 15 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 16 */ new LowLevelOperation(Opcode.DivChecked, 0),
                                /* 17 */ new LowLevelOperation(Opcode.GotoIfTrue, 23),
                                /* 18 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 19 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 20 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 21 */ new LowLevelOperation(Opcode.LoadConst, 2),
                                /* 22 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 23 */ new LowLevelOperation(Opcode.Goto, 28),
                                /* 24 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 25 */ new LowLevelOperation(Opcode.LoadConst, 10),
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 03 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                /* 04 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 05 */ new LowLevelOperation(Opcode.GotoIfTrue, 23),
                                /* 06 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 07 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 08 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 09 */ new LowLevelOperation(Opcode.LoadConst, 1),
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 12 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 13 */ new LowLevelOperation(Opcode.Goto, 14),
                                ...
                                /* 18 */ new LowLevelOperation(Opcode.LoadConst, 5),
                                /* 19 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 20 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 21 */ new LowLevelOperation(Opcode.Halt, 0)
                            }.ToImmutableArray(),
                            new Int32[]
                            {
                            }.ToImmutableArray(),
                ...
                new CompilationResult<Int32>(
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                /* 00 */ new LowLevelOperation(Opcode.LoadConst, 6),
                                /* 01 */ new LowLevelOperation(Opcode.Halt, 0)
                            }.ToImmutableArray(),
                            new Int32[]
                            {
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 07 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 08 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 09 */ new LowLevelOperation(Opcode.LoadConst, 3),
                                /* 10 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 11 */ new LowLevelOperation(Opcode.GotoIfTrue, 13),
                                /* 12 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 13 */ new LowLevelOperation(Opcode.Goto, 14),
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 03 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 04 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 05 */ new LowLevelOperation(Opcode.GotoIfTrue, 13),
                                /* 06 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 07 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 08 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 09 */ new LowLevelOperation(Opcode.LoadConst, 2),
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 03 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 04 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 05 */ new LowLevelOperation(Opcode.GotoIfFalse, 22),
                                /* 06 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 07 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 08 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 09 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                /* 10 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 11 */ new LowLevelOperation(Opcode.GotoIfFalse, 22),
                                /* 12 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 13 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 14 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 15 */ new LowLevelOperation(Opcode.LoadConst, 6),
                                /* 16 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 17 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 18 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 19 */ new LowLevelOperation(Opcode.LoadConst, 5),
                                /* 20 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 21 */ new LowLevelOperation(Opcode.PrintChar, 0),
                                /* 22 */ new LowLevelOperation(Opcode.GotoIfTrue, 24),
                                /* 23 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 24 */ new LowLevelOperation(Opcode.Goto, 25),
                                /* 25 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                /* 26 */ new LowLevelOperation(Opcode.Halt, 0)
                            }.ToImmutableArray(),
                            new Int32[]
                            {
                            }.ToImmutableArray(),
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 03 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                /* 04 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 05 */ new LowLevelOperation(Opcode.GotoIfTrue, 24),
                                /* 06 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 07 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 08 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 09 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 10 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 11 */ new LowLevelOperation(Opcode.GotoIfTrue, 24),
                                /* 12 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 13 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 14 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 15 */ new LowLevelOperation(Opcode.LoadConst, 6),
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 09 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 10 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 11 */ new LowLevelOperation(Opcode.GotoIfTrue, 19),
                                /* 12 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 13 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 14 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 15 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                /* 16 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 17 */ new LowLevelOperation(Opcode.GotoIfTrue, 19),
                                /* 18 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 19 */ new LowLevelOperation(Opcode.Goto, 20),
                                /* 20 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                /* 21 */ new LowLevelOperation(Opcode.Halt, 0)
                            }.ToImmutableArray(),
                            new Int32[]
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 08 */ new LowLevelOperation(Opcode.LoadConst, 2),
                                /* 09 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 10 */ new LowLevelOperation(Opcode.GotoIfGreaterThanOrEqual, 21),
                                /* 11 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 12 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 13 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 14 */ new LowLevelOperation(Opcode.LoadConst, 2),
                                /* 15 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 16 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 17 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 18 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 19 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                /* 20 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 21 */ new LowLevelOperation(Opcode.GotoIfLessThan, 23),
                                /* 22 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 23 */ new LowLevelOperation(Opcode.Goto, 24),
                                /* 24 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                /* 25 */ new LowLevelOperation(Opcode.Halt, 0)
                            }.ToImmutableArray(),
                            new Int32[]
                            {
                            }.ToImmutableArray(),
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 08 */ new LowLevelOperation(Opcode.LoadConst, 2),
                                /* 09 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 10 */ new LowLevelOperation(Opcode.GotoIfLessThan, 23),
                                /* 11 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 12 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 13 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 14 */ new LowLevelOperation(Opcode.LoadConst, 2),
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 11 */ new LowLevelOperation(Opcode.GotoIfFalse, 17),
                                /* 12 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 13 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 14 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 15 */ new LowLevelOperation(Opcode.LoadConst, 1),
                ...
                new CompilationResult<Int32>(
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            ...
                            {
                                new LowLevelUserDefinedOperator(
                                    new OperatorDefinition(Name: "true", NumOperands: 0),
                                    new LowLevelOperation[]
                                    {
                                        /* 00 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                        /* 01 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                        ...
                                        /* 11 */ new LowLevelOperation(Opcode.GotoIfTrue, 13),
                                        /* 12 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                        /* 13 */ new LowLevelOperation(Opcode.Return, 0),
                                        /* 14 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                        /* 15 */ new LowLevelOperation(Opcode.Return, 0)
                                    }.ToImmutableArray(),
                                    2)
                            }.ToImmutableArray(),
                            new String[]
                            ...
                            new LowLevelUserDefinedOperator[]
                            {
                                new LowLevelUserDefinedOperator(
                                    ...
                                    new LowLevelOperation[]
                                    {
                                        ...
                                        /* 24 */ new LowLevelOperation(Opcode.Return, 1),
                            ...
                            new LowLevelUserDefinedOperator[]
                            {
                                ...
                                new LowLevelUserDefinedOperator(
                                    ...
                                    new LowLevelOperation[]
                                    {
                                        ...
                                        /* 03 */ new LowLevelOperation(Opcode.Return, 3),
                                        ...
                                        /* 13 */ new LowLevelOperation(Opcode.Return, 3),
                            ...
                            new LowLevelUserDefinedOperator[]
                            {
                                ...
                                new LowLevelUserDefinedOperator(
                                    ...
                                    new LowLevelOperation[]
                                    {
                                        ...
                                        /* 09 */ new LowLevelOperation(Opcode.Return, 3),
                            ...
                            new LowLevelUserDefinedOperator[]
                            {
                                new LowLevelUserDefinedOperator(
                                    ...
                                    new LowLevelOperation[]
                                    {
                                        ...
                                        /* 43 */ new LowLevelOperation(Opcode.Return, 5),
                                        ...
                                        /* 88 */ new LowLevelOperation(Opcode.Return, 5),
                            ...
                            new LowLevelUserDefinedOperator[]
                            {
                                new LowLevelUserDefinedOperator(
                                    ...
                                    new LowLevelOperation[]
                                    {
                                        ...
                                        /* 34 */ new LowLevelOperation(Opcode.Return, 3),
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 32 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 33 */ new LowLevelOperation(Opcode.GotoIfGreaterThanOrEqual, 39),
                                ...
                                /* 37 */ new LowLevelOperation(Opcode.LoadConst, 5),
                                /* 38 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 39 */ new LowLevelOperation(Opcode.Goto, 48),
                                /* 40 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 41 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 42 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 43 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                /* 44 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 45 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 46 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 47 */ new LowLevelOperation(Opcode.LoadConst, 0),
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 03 */ new LowLevelOperation(Opcode.GotoIfGreaterThanOrEqual, 5),
                                /* 04 */ new LowLevelOperation(Opcode.LoadConst, 5),
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 31 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 32 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 33 */ new LowLevelOperation(Opcode.GotoIfGreaterThanOrEqual, 40),
                                /* 34 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 35 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 36 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 37 */ new LowLevelOperation(Opcode.LoadConst, 5),
                                /* 38 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 39 */ new LowLevelOperation(Opcode.StoreVariable, 0),
                                /* 40 */ new LowLevelOperation(Opcode.Goto, 50),
                                /* 41 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 42 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 43 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 44 */ new LowLevelOperation(Opcode.LoadConst, 1),
                                /* 45 */ new LowLevelOperation(Opcode.Add, 0),
                                /* 46 */ new LowLevelOperation(Opcode.LoadConst, 10),
                                /* 47 */ new LowLevelOperation(Opcode.Mult, 0),
                                /* 48 */ new LowLevelOperation(Opcode.LoadConst, 0),
                                /* 49 */ new LowLevelOperation(Opcode.Add, 0),
                    ...
                    Module:
                        new LowLevelModule<Int32>(
                            new LowLevelOperation[]
                            {
                                ...
                                /* 01 */ new LowLevelOperation(Opcode.Call, 0),
                                /* 02 */ new LowLevelOperation(Opcode.LoadConst, 1000),
                                /* 03 */ new LowLevelOperation(Opcode.GotoIfGreaterThanOrEqual, 6),
                                /* 04 */ new LowLevelOperation(Opcode.LoadConst, 5),
                                /* 05 */ new LowLevelOperation(Opcode.StoreVariable, 0),
