...
namespace Calc4DotNet.Core.Execution
{
    public static class LowLevelExecutor
    {
        ...
        {
            var result = ExecuteCore<Int32Operatable>(Unsafe.As<LowLevelModule<Int32>, LowLevelModule<Int32Operatable>>(ref module)); ;
            return Unsafe.As<Int32Operatable, Int32>(ref result);
        }

        public static Int64 Execute(LowLevelModule<Int64> module)
        {
            var result = ExecuteCore<Int64Operatable>(Unsafe.As<LowLevelModule<Int64>, LowLevelModule<Int64Operatable>>(ref module)); ;
            return Unsafe.As<Int64Operatable, Int64>(ref result);
        }

        public static Double Execute(LowLevelModule<Double> module)
        {
            var result = ExecuteCore<DoubleOperatable>(Unsafe.As<LowLevelModule<Double>, LowLevelModule<DoubleOperatable>>(ref module)); ;
            return Unsafe.As<DoubleOperatable, Double>(ref result);
        }

        public static BigInteger Execute(LowLevelModule<BigInteger> module)
        {
            var result = ExecuteCore<BigIntegerOperatable>(Unsafe.As<LowLevelModule<BigInteger>, LowLevelModule<BigIntegerOperatable>>(ref module)); ;
            return Unsafe.As<BigIntegerOperatable, BigInteger>(ref result);
        }

        private static TNumber ExecuteCore<TNumber>(LowLevelModule<TNumber> module)
            where TNumber : struct, IOperatableNumber<TNumber>
        {
